...
const Event = () => {
    return (
        <div className="w-full min-h-screen text-white px-6 sm:px-10 md:px-16 lg:px-20 z-40">


            <section className="w-full h-screen py-20">
                <div className="w-full h-3/4 md:h-full bg-cover bg-center bg-no-repeat bg-[url('/Images/eventpage.png')] object-contain flex items-end p-2 sm:p-5 md:p-8 lg:p-10">
