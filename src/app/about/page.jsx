...
const About = () => {
    return (
        <div className="w-full min-h-screen text-white z-40">
            <section className="w-full h-full py-10 flex flex-col justify-evenly gap-10 px-3 sm:px-10 md:px-16 lg:px-20">
            ...
            <section className="w-full flex flex-col min-h-screen px-3 md:px-16 lg:px-20 py-10 gap-10 items-center">
                <h1 className="text-xl sm:text-2xl  text-center md:text-5xl  font-bold uppercase">team leaders of our club</h1>
